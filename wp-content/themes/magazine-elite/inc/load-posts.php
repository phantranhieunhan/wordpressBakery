...
if ( ! function_exists( 'magazine_elite_ajax_pagination' ) ) :
    /**
...
if ( ! function_exists( 'magazine_elite_load_more' ) ) :
    /**
     ...
     *
     */
    function magazine_elite_load_more() {
...
add_action( 'wp_ajax_magazine_elite_load_more', 'magazine_elite_load_more' );
add_action( 'wp_ajax_nopriv_magazine_elite_load_more', 'magazine_elite_load_more' );