 ...
 */
class Magazine_Elite_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @access public
 */
class Magazine_Elite_Customize_Section_Upsell extends WP_Customize_Section {
