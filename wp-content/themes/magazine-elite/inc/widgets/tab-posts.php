<?php
/**
 * Adds Magazine_Elite_Tab_Posts widget.
 */
class Magazine_Elite_Tab_Posts extends WP_Widget {
    /**
    ...
    function __construct() {
        parent::__construct(
            'magazine_elite_tab_posts_widget',
            esc_html__( 'ME: Tab Posts', 'magazine-elite' ),
            array( 'description' => esc_html__( 'Displays posts in tabs', 'magazine-elite' ), )
        );
    }
            ...
            <div class="tabbed-head">
                <ul class="nav nav-tabs primary-background secondary-font" role="tablist">
                    <li role="presentation" class="tab tab-popular active">
                        <a href="#ms-popular" aria-controls="<?php esc_html_e('Popular', 'magazine-elite'); ?>" role="tab" data-toggle="tab" class="primary-bgcolor">
                            <?php esc_html_e('Popular', 'magazine-elite'); ?>
                        </a>
                    </li>
                    <li class="tab tab-recent">
                        <a href="#ms-recent" aria-controls="<?php esc_html_e('Recent', 'magazine-elite'); ?>" role="tab" data-toggle="tab" class="primary-bgcolor">
                            <?php esc_html_e('Recent', 'magazine-elite'); ?>
                        </a>
                    </li>
                </ul>
            </div>
    ...
    public function form( $instance ) {
        ...
        <h4 class="widefat" style="text-align:center;background-color:#f1f1f1;padding:5px 0;margin-top:5px;">
            <span class="field-label"><strong><?php _e('Popular','magazine-elite') ?></strong></span>
        </h4>
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'no_of_popular_posts' ) ); ?>">
                <?php esc_attr_e( 'No of Posts:', 'magazine-elite' ); ?>
            </label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'popular_content_length' ) ); ?>">
                <?php esc_attr_e( 'Content Length (Words):', 'magazine-elite' ); ?>
            </label>
        ...
        <h4 class="widefat" style="text-align:center;background-color:#f1f1f1;padding:5px 0;margin-top:5px;">
            <span class="field-label"><strong><?php _e('Recent','magazine-elite') ?></strong></span>
        </h4>
        <p>
