<?php
/**
 * Adds Magazine_Elite_Author_Info widget.
 */
class Magazine_Elite_Author_Info extends WP_Widget {
    /**
    ...
    function __construct() {
        parent::__construct(
            'magazine_elite_author_info_widget',
            esc_html__( 'ME: Author Info', 'magazine-elite' ),
            array( 'description' => esc_html__( 'Displays author short info.', 'magazine-elite' ), )
        );
    }
        ...
        <div class="author-info">
            ...
            <div class="author-details">
                <?php if (!empty($instance['author_name'])) { ?>
                    <h3 class="author-name tertiary-font"><?php echo esc_html($instance['author_name']); ?></h3>
                <?php } ?>
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('title')); ?>">
                <?php esc_attr_e('Title:', 'magazine-elite'); ?>
            </label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('author_name')); ?>">
                <?php esc_attr_e('Author Name:', 'magazine-elite'); ?>
            </label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('author_desc')); ?>">
                <?php esc_attr_e('Short Description:', 'magazine-elite'); ?>
            </label>
        ...
        <div>
            <label for="<?php echo esc_attr( $this->get_field_id( 'author_img' ) ); ?>">
                <?php esc_attr_e('Author Image:', 'magazine-elite'); ?>
            </label>
            <!-- <br /> -->
            <input type="button" class="select-img button button-primary" value="<?php esc_attr_e( 'Upload', 'magazine-elite' ); ?>" data-uploader_title="<?php esc_attr_e( 'Select Image', 'magazine-elite' ); ?>" data-uploader_button_text="<?php esc_attr_e( 'Choose Image', 'magazine-elite' ); ?>" />
            <?php
            $image_status = false;
            if ( ! empty( $author_img ) ) {
                $image_status = true;
            ...
            ?>
            <input type="button" value="<?php echo _x( 'X', 'Remove', 'magazine-elite' ); ?>" class="button button-secondary btn-image-remove" style="<?php echo esc_attr( $remove_button_style ); ?>" />
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('fb_url')); ?>">
                <?php esc_attr_e('Facebook URL:', 'magazine-elite'); ?>
            </label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('twitter_url')); ?>">
                <?php esc_attr_e('Twitter URL:', 'magazine-elite'); ?>
            </label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('gplus_url')); ?>">
                <?php esc_attr_e('GooglePlus URL:', 'magazine-elite'); ?>
            </label>
